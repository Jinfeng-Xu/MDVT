...
def quick_start(model, dataset, config_dict, save_model=True, mg=False, vp='0'):
    # merge config dict
    config = Config(model, dataset, config_dict, mg, vp)
    init_logger(config)
    logger = getLogger()
    # print config infor
    ...
    for hyper_tuple in combinators:
        ...
        trainer = get_trainer()(config, model, mg, vp)
        # debug
        # model training
