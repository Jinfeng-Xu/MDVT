...
class FREEDOM_VP(GeneralRecommender):
    def __init__(self, config, dataset):
        super(FREEDOM_VP, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        if self.flag:
            ...
            return (1-self.s_weight)*(batch_mf_loss + self.reg_weight * (mf_t_loss + mf_v_loss)) + s_loss_value
